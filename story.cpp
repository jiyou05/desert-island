...
list <char> story1()
{
    ...
    string script2 = "근처에 돌이 보여 이를 집어들었다. \n\n";
    scriptEx(script2, cnt1);

    printf("1. 원숭이를 달래보자. \n");
    printf("2. 원숭이쯤이야. 싸워서 가져오지 뭐! \n\n");
    cnt1++;
...
list<char> story1_1_2() // 인벤토리에서 자몽 사용
{
    ...
    string script3 = "다행히 옷 안에 있던 주머니칼도 멀쩡하다. 꼭 잘 간수하도록 하자. \n\n";
    cnt1_1_2++;
...
{
    string script1 = "몇 번 던져보았는데 하다도 맞지 않다니... \n";
...
list<char> story1_2_1_1() //왼쪽으로 던진 경우
{
    ...
    Sleep(SLEEP_TIME);
    string script2 = "뭔가 이상하다... \n어디선가 무리지어 달려오는 소리가 들린다. \n\n";
...
list<char> story2_2() // 인벤토리에서 안경 사용
{
    ...
    string script2 = "몸이 따뜻해지니 배가 고파지기 시작했다. \n\n";
...
list<char> story3_1_e()
{
    ...
    string script5 = "저기 모래사장 근처 뗏목이 희마하게 보였다. \n\n";
...
list<char> story3_3() //숲으로
{
    ...
    Sleep(SLEEP_TIME);
    printf(" 갈림길을 총 3번 만나게 되며 2번 이상 만났다면 토끼를 잡는데 성공한다! \n\n");
    printf("-----------------------------------------------------------------------\n\n");
...
{
    string script1 = "저기가 지나간 흔적이 보인다! 갈림길이 있군! \n\n";
